...
CATALOG_IMG=${CATALOG_IMG:-quay.io/lee_forster/mas-iam-operator:catalog-0.0.13}
CATALOG_NAME=${CATALOG_NAME:-mas-iam-operator-dev}
CATALOG_NAMESPACE=${CATALOG_NAMESPACE:-openshift-marketplace}
CATALOG_DISPLAY_NAME=${CATALOG_DISPLAY_NAME:-"MAS EST IAM Operator (dev)"}

TARGET_NAMESPACE=${TARGET_NAMESPACE:-mas-est}
OPERATOR_GROUP_NAME=${OPERATOR_GROUP_NAME:-mas-est-operator-group}
