...
| **mas-est CLI**      | `quay.io/lee_forster/mas-external-services-tool:v0.1.6`              | Local installer, preflight, status, support-bundle, uninstall                                   | Yes                               |
...
```bash
export MAS_EST_IMAGE='quay.io/lee_forster/mas-external-services-tool:v0.1.6'
