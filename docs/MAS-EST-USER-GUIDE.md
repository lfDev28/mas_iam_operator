...
subtitle: "User Guide — `mas-est` v0.1.0-beta.24"
...
| **SCIM bridge**      | `quay.io/lee_forster/mas-scim-bridge:v0.1.0-beta.24`                         | Polls Keycloak every 5 min, provisions users with prefix `scim.` into MAS                       | Yes                               |
...
| **mas-est CLI**      | `quay.io/lee_forster/mas-external-services-tool:v0.1.0-beta.24`              | Local installer, preflight, status, support-bundle, uninstall                                   | Yes                               |
...
mas-est version    # should report 0.1.0-beta.24
```
