...
CONTAINER_ENGINE=podman IMG=quay.io/<org>/mas-iam-operator:0.1.0 make docker-build docker-push
```
...
IMG=quay.io/<org>/mas-iam-operator:0.1.0 make deploy
```
...
```bash
VERSION=0.1.0 make bundle
CONTAINER_ENGINE=podman VERSION=0.1.0 BUNDLE_IMG=quay.io/<org>/mas-iam-operator-bundle:0.1.0 make bundle-build bundle-push
```
...
```bash
CONTAINER_ENGINE=podman VERSION=0.1.0 \
  IMG=quay.io/<org>/mas-iam-operator:0.1.0 \
  BUNDLE_IMG=quay.io/<org>/mas-iam-operator-bundle:0.1.0 \
  CATALOG_IMG=quay.io/<org>/mas-iam-operator:catalog-0.1.0 \
